...
def main() -> None:
    ...
    city_y, cap_y, hous, ymult, _sl, _em = sim._gov_policy_mods(c0)
    ...
    city_y, cap_y, hous, ymult, _sl, _em = sim._gov_policy_mods(c1)
    ...
    city_y, cap_y, hous, ymult, _sl, _em = sim._gov_policy_mods(c3)
    ...
    city_y, cap_y, hous, ymult, sl4, _em = sim._gov_policy_mods(c4)
    GOLD2 = 2
    ...
    cy, cpy, ch, cym, _s2, _e2 = sim2._gov_policy_mods(civics_with(["CODE_OF_LAWS"]))
