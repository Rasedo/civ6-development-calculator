...
def main() -> None:
    ...
    city_y, cap_y, hous, ymult, _sl = sim._gov_policy_mods(c0)
    ...
    city_y, cap_y, hous, ymult, _sl = sim._gov_policy_mods(c1)
    ...
    city_y, cap_y, hous, ymult, _sl = sim._gov_policy_mods(c2)
    ...
    city_y, cap_y, hous, ymult, _sl = sim._gov_policy_mods(c3)
    ...
    city_y, cap_y, hous, ymult, sl4 = sim._gov_policy_mods(c4)
    GOLD2 = 2
