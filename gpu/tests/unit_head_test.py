...
def main() -> None:
    ...
    assert len(acts) == 13 + len(imp_ids) + 3 + 12 + 7, (  # #92: +12 SNIPE; #93: +7 SPREAD
    ...
    assert acts[26] == "SNIPE_0" and acts[37] == "SNIPE_11", (  # #93: SPREAD sits past 37 now — key on the SEAT, not W-1
