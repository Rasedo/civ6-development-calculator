"""B-29 combat-modifier self-test: the wounded-strength penalty and the
...
def find_melee(rules, paths):
    """Scripted-advance until a player MELEE unit can strike an adjacent
    barb/rival unit (not a city) — returns (sim, p, code, name)."""
    for path in paths:
