...
import { PREVAILING_WINDS, STORM_MOVEMENT, FLOOD_SEVERITY_P, FLOOD_DESTROY_P, FLOOD_DISTRICT_P, FLOOD_BLDG_P, FLOOD_POP_P, FLOOD_DAMAGE_LO, FLOOD_DAMAGE_HI, FLOOD_FERT_FOOD, FLOOD_FERT_PROD, floodTerrainColumn, FLOOD_CHANCE, ERUPTION_CHANCE_PER_VOLCANO, SOIL_PAINT_P, ERUPTION_SEVERITY, SOIL_REPLACES, DROUGHT_CHANCE, DROUGHT_LENGTH, STORM_EVENTS, STORM_FAMILIES, STORM_UNIT_ROWS } from '../data/disasters';
import {
...
export function buildRules() {
  const rules = {
    ...
    disasters: {
      ...
      // the per-plot Volcanic Soil chance at the severity every eruption
      // takes, and the feature ids the soil replaces
      soilPaintP: SOIL_PAINT_P[ERUPTION_SEVERITY],
