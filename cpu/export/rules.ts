...
export function buildRules() {
  const rules = {
    ...
    seats: {
      ...
      // the Free Cities player's strength floor and the defenders a revolt grants
      freeCityDefense: FREE_CITY_DEFENSE,
      freeCityGrantMelee: Object.keys(UNITS).indexOf(FREE_CITY_GRANT_MELEE),
      freeCityGrantMeleeCount: FREE_CITY_GRANT_MELEE_COUNT,
      freeCityGrantRanged: Object.keys(UNITS).indexOf(FREE_CITY_GRANT_RANGED),
      freeCityGrantRangedTurns: FREE_CITY_GRANT_RANGED_TURNS,
