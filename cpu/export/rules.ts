...
export function buildRules() {
  const rules = {
    ...
    seats: {
      ...
      // the RESEARCH AGREEMENT: both parties' tech gate, and the share of their
      // combined science a turn the pact banks against the target's cost
      researchAgreementTech: Object.keys(TECHS).indexOf(RESEARCH_AGREEMENT_TECH),
      researchAgreementPct: RESEARCH_AGREEMENT_PCT,
