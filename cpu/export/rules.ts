...
import { GW_HOLDERS, GW_LAYOUT, GW_LAYOUT_W, GWS_ACCEPTS, GWO_COUNT, GWO_CULTURE, GWO_FAITH, GWO_TOURISM, gwKindOf, EXTRA_SLOT_ROWS, AUTO_THEME_ROWS, THEMING_MULT as GW_THEMING_MULT } from '../data/greatWorks';
