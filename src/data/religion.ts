...
/**
 * B-18 (#71): the APOSTLE BUY switch — LIVE since 2026-07-27.
 *
 * The apostle unit, its religious strength, theological combat and the
 * scripted rival purchase are all on. Getting here took a long hunt whose
 ...
 *    FOREVER (seed 9183: t87 alive=False hp=0 yet occ363 still read its slot),
 ...
 *    had occupied (seed 9235 t85: a missionary walked 341->340->296 straight
 ...
 *    order is this codebase's shared convention (B-31 capture deliberately
 ...
 *    position, so the engines chose different defenders (seed 9040 t207: TS
 *    #171 apostle vs GPU's lower-slotted #176 missionary), splitting the
 ...
 */
export const APOSTLE_BUY_LIVE = true; // #71 hunt
