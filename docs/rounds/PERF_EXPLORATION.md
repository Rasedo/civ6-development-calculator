...
`tools/cpu/perf-turns.ts` (TS headless, 3 seeds × 250t). These reproduce the
...
- **rollout part**: 104.7s / 250t (2.4 t/s). `step` 94.3s cum (90.1%),
  ...
  calls / 4.25s.
- **TS `perf-turns.ts`**: 286 t/s total (232 / 316 / 334 on seeds
...
| TS perf-turns          | 286 t/s     | 408 t/s    | +43%  |
