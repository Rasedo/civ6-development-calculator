...
# the bodies below write (the merged unit pool, `military_at`/`civilian_at`,
# `civ_civics`, `ded_picks`, `era_score`, `seat_ext`) is in `_MUTABLE`, so
# `restore` carries it all back; no poke holds two of these sims live at once.
