...
/**
 * AUDIT #78 — YOSEMITE, sourced from the Civilopedia
...
/**
 * #78 (owner correction): natural-wonder and mountain tiles carry a FIXED
 * appeal that adjacency cannot move — 5 and 4 respectively. Only blanket auras
...
describe('#78 fixed appeal bases', () => {
  ...
  it('a natural-wonder tile is 5 regardless of neighbours', async () => {
    const { tileAppeal } = await import('../src/core/appeal');
